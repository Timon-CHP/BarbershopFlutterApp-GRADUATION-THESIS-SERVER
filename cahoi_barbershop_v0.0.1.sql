...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 07, 2022 lúc 05:37 AM
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`rank_member_id`) REFERENCES `rank_member` (`rank_member_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
